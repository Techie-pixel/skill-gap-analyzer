  ...
  return (
    <div className="flex h-[60vh] flex-col items-center justify-center space-y-6">
      <div className="relative flex items-center justify-center">
        <div className="h-16 w-16 animate-spin rounded-full border-4 border-zinc-800 border-t-teal-500" />
        <div className="absolute h-10 w-10 animate-pulse rounded-full bg-teal-500/20 blur-xl" />
      </div>
      <div className="text-center">
        <h3 className="text-lg font-semibold text-white">Analyzing Your Profile...</h3>
        <p className="mt-2 text-sm text-zinc-400">Our AI is matching your skills with industry requirements.</p>
      </div>
    </div>
  );
}
